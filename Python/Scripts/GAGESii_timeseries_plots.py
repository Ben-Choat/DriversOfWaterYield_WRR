...
# define which mod el you want to work with
model_work = 'strd_PCA_mlr' # ['XGBoost', 'strd_PCA_mlr', 'strd_PCA_lasso', 'strd_pc]
...
models_list = glob.glob(
    f'{dir_work}/data_out/{time_scale}/VIF_dfs/{clust_meth}_{region}_*'
    )
print(models_list)
...
p = (
    ...
    p9.geom_line(p9.aes(
        ...
        p9.theme_bw() +
        p9.ggtitle(
            f'eCDF of {metr_in} in {region}-{train_val} from {model_work}'
        )
